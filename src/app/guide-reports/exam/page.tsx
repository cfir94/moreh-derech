    ...
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <header className="screen-in mb-7">
        ...
        <p className="max-w-2xl leading-relaxed text-txt-dim">
          החלק הפתוח של מבחן הרישוי, בטפסים המקוריים של משרד התיירות: שלוש
          קבוצות, בוחרים אחת, ובונים לה יום שלם — טבלת יום, שש יחידות הדרכה
          קצרות לפי רשימת דרישות, ויחידה מורחבת אחת.
        </p>
      </header>
